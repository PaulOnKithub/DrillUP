        ...
        try {
            ...
            for (int i = 1; i <= totalRows; i++) { // Start from the second row
                ...
                if(arInfo2!=null){
                    ...
                    row.createCell(3,CellType.STRING).setCellValue(LocalDate.parse(arInfo2[1],customFormatter).toString());
                    row.createCell(4,CellType.STRING).setCellValue(LocalDate.parse(arInfo2[2],customFormatter).toString());
